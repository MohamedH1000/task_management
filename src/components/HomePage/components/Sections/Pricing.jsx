    ...
    <Wrapper id="pricing">
      <div className="whiteBg">
        <div className="container">
          <HeaderInfo>
            <h1 className="font40 extraBold">الباقات</h1>
            <p className="font13">
              فانتك يساعدك في إدارة و مراقبة مشاريعك مع فريقك بشكل أسرع و أذكى ،
              و لايتطلب منك خبره مسبقة لكي تدير عملك
            </p>
          </HeaderInfo>
